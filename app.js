...
const addButton = document.querySelector(".add__button");//first button
...
const createNewTaskElement = function(taskString){
  ...
  label.classList.add("list__label", "label");
...
const addTask = function(){
  ...
  //Append listItem to incomplete-task-holder
...
const editTask=function(){
  ...
  //If class of the parent is .list__item--edit-mode
  if(containsClass){
    //switch to .list__item--edit-mode
  ...
  //toggle .list__item--edit-mode on the parent.
...
const taskIncomplete = function(){
  ...
  const listItem = this.parentNode;
  const label = listItem.querySelector('.label');
  label.classList.remove('label--completed');
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem,taskCompleted);
}
...
const bindTaskEvents = function(taskListItem, checkBoxEventHandler){
  ...
  checkBox.addEventListener('change', checkBoxEventHandler, {once: true});
}
